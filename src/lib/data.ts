...
export const cheeseBoards: CheeseBoard[] = [
  ...
  },
  {
    ...
    "description": "Una experiencia gourmet para los amantes del queso, elaborada con una selección de quesos premium para los paladares más exigentes. *Nuestras tablas son de madera de pino y están curadas para uso alimenticio. **¡Te la quedas de regalo!**.",
