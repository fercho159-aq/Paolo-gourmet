...
export const cheeseBoards: CheeseBoard[] = [
  ...
  },
  {
    ...
    "cheeses": ["Brie o Camembert", "Esferas de queso crema con arándanos", "Cheddar, Manchego o Gouda"],
    "fruits": ["Uvas", "Kiwi", "Blueberries", "Zarzamoras", "Frambuesas", "Fresas", "Higo", "Chabacano"],
    "meats": ["Jamón serrano (15 meses de maduración)", "Salami seco estilo italiano o chorizo español"],
    "accompaniments": ["Galletas integrales", "Aceitunas", "Miel de abeja", "Ate de membrillo", "Pretzel", "Nueces y pistaches"],
    "serving": "3 a 5 personas",
    "dimensions": "20x30 cm",
  ...
  },
  {
    ...
    "cheeses": ["Brie o Camembert", "Esferas de queso crema con arándanos o nuez", "Cheddar, Manchego o Gouda"],
    "fruits": ["Uvas", "Kiwi", "Blueberries", "Zarzamoras", "Frambuesas", "Fresas", "Higo", "Chabacano"],
    "meats": ["Jamón serrano (15 meses de maduración)", "Salami seco estilo italiano o chorizo español"],
    "accompaniments": ["Galletas integrales", "Aceitunas", "Miel de abeja", "Ate de membrillo", "Pretzel", "Nueces y pistaches"],
  ...
  },
  {
    ...
    "description": "Una experiencia gourmet para los amantes del queso. Curada con una selección de quesos premium para los paladares más exigentes. *Nuestras tablas son de madera de pino y están curadas para uso alimenticio. **¡Te la quedas de regalo!***",
    ...
    "cheeses": ["Queso Brie", "Queso Manchego Cabernet Sauvignon", "Queso Provolone", "Queso de Cabra con arándanos", "Queso Cheddar", "Queso Parmesano", "Queso Cotija"],
    "fruits": ["Uvas", "Kiwi", "Blueberries", "Zarzamoras", "Frambuesas", "Fresas", "Higo", "Chabacano"],
    "meats": [],
  ...
  },
  {
    ...
    "description": "Queso Brie o Camembert.",
  ...
  },
  {
    ...
    "line": "Ordenes extras",
    "name": "Jamón Serrano",
    "description": "Jamón serrano (15 meses de maduración).",
  ...
  },
  {
    ...
    "line": "Ordenes extras",
    "name": "Salami",
    "description": "Salami seco estilo italiano.",
  ...
  },
  {
    ...
    "description": "¡Claro que sí! Celebra cualquier ocasión especial con nuestras divertidas letras personalizadas. Ideales para cumpleaños, aniversarios, Día de las Madres y graduaciones.",
