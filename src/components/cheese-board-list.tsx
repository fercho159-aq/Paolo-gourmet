    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {cheeseBoards.map(board => (
          <Link href={`/product/${board.id}`} key={board.id} className="flex">
            <Card className="flex flex-col overflow-hidden shadow-md transition-shadow hover:shadow-xl h-full w-full">
