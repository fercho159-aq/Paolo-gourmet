...
import { Menu, ChevronDown, Box, Instagram, Facebook, Star, Quote } from 'lucide-react';
...
function CuttingBoardIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M22 10a2 2<path d="M22 10a2 2 0 0 0-2-2m0 0a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2z" />
    </svg>
  );
}
