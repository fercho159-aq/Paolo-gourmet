  ...
  return (
    <section className="relative w-full h-[60vh] min-h-[500px] overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-start justify-center text-left text-white container animate-fade-in-up">
        ...
        <Button size="lg" className="mt-8 text-white" asChild style={{ backgroundColor: '#dcd0b3' }}>
    ...
    <section id="contact" className="w-full py-16 md:py-20 lg:py-24 animate-fade-in-up">
      <div className="container px-4 md:px-6">
        <div className="space-y-3 mb-12 text-center">
          <h2 className="text-3xl font-normal tracking-tighter md:text-4xl/tight" style={{ color: '#dcd0b3' }}>
          ...
          <div className="space-y-6">
            <div className="bg-secondary/50 p-6 rounded-lg space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild className="flex-1" style={{ backgroundColor: '#dcd0b3', color: 'white' }}>
...
function Footer() {
    ...
    return (
        <footer className="w-full text-white py-6" style={{ backgroundColor: '#dcd0b3' }}>
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <div className="sticky top-0 z-50">
        <div style={{ backgroundColor: '#dcd0b3' }} className="py-2 text-center text-xs md:text-sm text-white">
