...
function Gallery() {
  const galleryImages = [
    { src: "https://placehold.co/600x400.png", alt: "Detalle de una tabla de quesos", hint: "primer plano queso" },
    { src: "https://placehold.co/600x400.png", alt: "Gente disfrutando de las tablas de queso en un evento", hint: "amigos comiendo" },
    { src: "https://placehold.co/600x400.png", alt: "Una tabla de quesos rústica con vino", hint: "queso vino" },
    { src: "https://placehold.co/600x400.png", alt: "Tabla de quesos temática de postre", hint: "tabla de postres" },
  ];
          ...
          {galleryImages.map((image, index) => (
            <div key={index} className="overflow-hidden rounded-xl">
              <Image
                ...
                width={600}
                height={400}
                className="aspect-square object-cover w-full h-full transition-transform duration-300 hover:scale-110"
              />
            </div>
          ))}
        </div>
