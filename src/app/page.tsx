...
function TikTokIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M22.98,9.78a4.95,4.95,0,0,0-5.1-5.1c-1.8,0-3.51.69-4.88,1.83V2.41a1,1,0,0,0-1-1H7.83a1,1,0,0,0-1,1v14a4.89,4.89,0,0,0,4.88,4.88c2.19,0,4.12-1.42,4.72-3.48a1,1,0,0,0-.2-1.06,1,1,0,0,0-1.06-.2,2.83,2.83,0,0,1-2.48,1.55,2.89,2.89,0,0,1-2.88-2.88V10.46c.39-.18.78-.38,1.15-.6a7.48,7.48,0,0,1,3.31-1.33C19.46,8.27,21.53,8.44,22.98,9.78Z"/>
    </svg>
  );
}
